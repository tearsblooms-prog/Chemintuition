...
class ReactionDataset(torch.utils.data.Dataset):
    """
    Load reaction data from preprocessed CSV and NPZ files (main reaction + conditions).
    """
    ...
    def __init__(self, csv_file_path, graphs_npz_path):
        ...
        Args:
            ...
            graphs_npz_path (str): Path to the NPZ file containing all preprocessed graphs.
        """
    ...
    def _load_graph(self, prefix: str, index: int) -> Data:
        """
        Load the main reaction graph from npz storage and convert it to a torch_geometric.data.Data object.
        """
