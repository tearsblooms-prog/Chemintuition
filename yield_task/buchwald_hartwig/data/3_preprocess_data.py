...
def main():
    # --- Configuration ---
    source_csv_path = 'buchwald_hartwig_processed_with_fingerprints.csv'
    id_to_chem_json_path = 'id_to_chemical.json'
    cleaned_csv_path = 'buchwald_hartwig_cleaned.csv'
