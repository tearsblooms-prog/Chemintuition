...
print("Initializing DualChannelMPNN (training from scratch)...")
...
def run_test_and_generate_table(model, mpnn_model, test_loader, tokenizer, device):
    ...
    FEATURES_TO_EVALUATE = {
        'c': {'type': 'discrete', 'token_rel_pos': 5}, 's1': {'type': 'discrete', 'token_rel_pos': 9},
    ...
    print("\nChemical context condition accuracy")
    print("-" * 80)
